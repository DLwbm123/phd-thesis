...
- `FDSDSthesis.cls`
- `FontStyle/SimSun.ttf`、`FontStyle/SimHei.ttf`、`FontStyle/SimKai.ttf`
- `fig/FudanLOGO.pdf`（及模板附带图件）

模板文件保留原始版权和发行说明。为承载本论文的既有算法环境及已确认的封面字段，类文件仅作必要兼容调整：使用 `algorithm2e`，以及专业学位封面在“院系”下保留“专业：电子信息”的字段标签。
