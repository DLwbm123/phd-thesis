...
\centering
\thesisgraphic{ch03/screenshots/medcl_segmentation_axial.png}
\par\small (b) Z 方向切面
\end{minipage}\hfill
\begin{minipage}[t]{0.315\linewidth}
\centering
\thesisgraphic{ch03/screenshots/medcl_segmentation_coronal.png}
\par\small (c) Y 方向切面
\end{minipage}\hfill
\begin{minipage}[t]{0.315\linewidth}
\centering
\thesisgraphic{ch03/screenshots/medcl_segmentation_sagittal.png}
\par\small (d) X 方向切面
\end{minipage}
\par\vspace{6pt}
\begin{minipage}{0.48\linewidth}
\centering
\thesisgraphic{ch03/screenshots/medcl_segmentation_3d.png}
\par\small (e) 七类心脏结构三维分割
\end{minipage}
...
图\ref{fig:medcl-weak-example-ui}展示弱监督示例的任务与切片设置，以及原始影像、稀疏涂鸦和分割叠加的对照。
\begin{figure}[htbp]
\centering
\begin{minipage}{0.96\linewidth}
\centering
\thesisgraphic{ch03/screenshots/medcl_weak_settings.png}
\par\small (a) 任务与切片设置
\end{minipage}
\par\vspace{6pt}
\begin{minipage}[t]{0.315\linewidth}
\centering
\thesisgraphic{ch03/screenshots/medcl_weak_image.png}
\par\small (b) 原始影像
\end{minipage}\hfill
\begin{minipage}[t]{0.315\linewidth}
\centering
\thesisgraphic{ch03/screenshots/medcl_weak_scribble.png}
\par\small (c) 稀疏涂鸦
\end{minipage}\hfill
\begin{minipage}[t]{0.315\linewidth}
\centering
\thesisgraphic{ch03/screenshots/medcl_weak_overlay.png}
\par\small (d) 分割叠加
\end{minipage}
...
分类示例显示选定任务中的图像及类别，用于核对类别语义；正式分类结果保持任务和客户端层面的聚合展示。配准查看器提供固定、移动和外部生成的配准后影像，支持切面与融合查看。独立配准示例还提供棋盘格和彩色融合，其“对齐参考”以固定影像表示目标状态，不作为计算得到的变形结果。定量 TRE 由预测对应点与隐藏固定地标计算。
