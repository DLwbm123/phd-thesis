...
在输出组织上，本章采用任务增量设定。测试时任务身份已知，并选择相应的任务特定分类头。PGS 投影作用于共享特征提取器中可训练的卷积层和全连接权重层；分类头和其他未选参数按常规方式更新。该设定不等同于测试时任务身份未知的类增量学习，也不覆盖任务切换自动检测或开放世界识别。
...
Re-Fed$^{\ast}$ & 87.13 & -5.31 & \textcolor{red}{\textbf{80.72}} & -15.41 & 73.96 & -13.11 & 73.79 & -12.88 \\
DDDR$^{\ast}$ & 88.93 & -4.01 & 77.30 & -14.87 & 75.27 & -12.15 & \textcolor{red}{\textbf{77.24}} & \textcolor{red}{\textbf{-10.30}} \\
FedSubMerge & 90.97 & \textcolor{red}{\textbf{-0.86}} & 77.50 & \textcolor{red}{\textbf{-14.30}} & \textcolor{red}{\textbf{78.64}} & \textcolor{red}{\textbf{-6.55}} & 76.64 & -10.55 \\
FedSubMerge-AD & \textcolor{red}{\textbf{93.42}} & -3.37 & 79.40 & -16.85 & 78.12 & -10.95 & 76.16 & -13.05 \\
\bottomrule
\end{tabular}%
}
\end{table}
