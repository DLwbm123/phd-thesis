...
第三章的 MedCL 平台以任务序列和阶段--任务性能矩阵组织持续学习评价，并通过分割基准考察中心变化、类别扩展和跨器官任务变化。本章沿用其中的六中心前列腺 Domain-CL 与三任务心脏结构 Class-CL 设置，将训练监督由密集掩膜改为固定模拟涂鸦，研究标注信息受限时的新任务学习与历史知识保持。实验继续采用平台的 A-Dice、BWTR 和 RMA，分别使用 E-FWT 与 WCD 评价未来域泛化和全类别分割表现，并结合 MPE 与 DRR 分析模型扩展和历史信息使用。
...
相较 Dense-Sequential，ZSDERpp 的 A-Dice 和 BWTR 分别提高 $0.0927$ 和 $0.0850$，RMA 与 E-FWT 分别低 $0.1870$ 和 $0.0350$。
