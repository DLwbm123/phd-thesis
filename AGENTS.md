...
- 不得将文献键 `zhang2026zscribbleseg` 对应的静态弱监督论文写成持续学习方法或本文研究工作；
- ScribbleCL 的当前任务弱监督模块可引用该论文的机制；持续学习任务、基线、指标和结果必须有新增实验记录，静态机制与结果必须明确标为文献事实；
...
- 被引用静态弱监督论文与新增 ScribbleCL 研究的证据边界清楚；
