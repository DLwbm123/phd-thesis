...
\begin{scope}[shift={(9.05,0)}]
  ...
  \node[data, minimum width=1.75cm] (f-c2) at (1.05,2.05)
    {客户端 2\\本地数据};
  \node[note] at (1.05,1.4) {$\vdots$};
  \node[data, minimum width=1.75cm] (f-ck) at (1.05,0.75)
    {客户端 $K$\\本地数据};
  \node[process, minimum width=2.05cm, minimum height=3cm] (f-server) at (4.30,2.05)
    {服务器\\聚合与下发};
  \node[process, minimum width=1.95cm] (f-global) at (7.10,2.05)
    {共享模型};
