...
\begin{tikzpicture}[
  ...
  task/.style={box,minimum width=3.75cm,minimum height=2.1cm,fill=black!1}
]
...
\node[inner sep=0pt] at (8.65,.7) {\includegraphics[height=1.5cm]{ch07/assets/example-000.png}};
...
\node[task] (task1) at (1.875,-5.22) {};
\node[task] (task2) at (6.55,-5.22) {};
\node[task] (task3) at (11.225,-5.22) {};
\node[labeltext,font=\thesisfigurefont\bfseries] at (1.875,-4.5) {任务一\quad 胸部 X 线诊断};
\node[labeltext,font=\thesisfigurefont\bfseries] at (6.55,-4.5) {任务二\quad 消化内镜识别};
\node[labeltext,font=\thesisfigurefont\bfseries] at (11.225,-4.5) {任务三\quad 皮肤镜分类};
\node[inner sep=0pt] at (1.875,-5.35) {\includegraphics[height=1.18cm]{ch07/assets/example-001.png}};
\node[inner sep=0pt] at (6.55,-5.35) {\includegraphics[height=1.18cm]{ch07/assets/example-002.png}};
\node[inner sep=0pt] at (11.225,-5.35) {\includegraphics[height=1.18cm]{ch07/assets/example-003.png}};
...
\node[labeltext,text=black!65] at (6.55,-6.62) {顺序适配\quad $\longrightarrow$\quad 阶段评价};
\draw[draw=black!20,line width=.55pt] (0,-7.03) -- (13.1,-7.03);
\node[labeltext] at (6.55,-7.48)
