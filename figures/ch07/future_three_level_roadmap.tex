...
\begin{tikzpicture}[
  ...
  direction/.style={circle,minimum size=3.35cm,draw,line width=.85pt,inner sep=0pt},
...
\node[labeltext,text=routegold] at (11.15,.7) {任务与场景};
\node[labeltext,font=\thesisfigurefont\bfseries] at (11.15,.08) {持续领域适配};
\node[labeltext,text=black!65] at (11.15,-.6) {新场景\quad 参数高效};
...
\node[circle,minimum size=2.65cm,draw=black!65,fill=black!3,line width=.9pt,inner sep=0pt] (goal) at (6.55,-.6) {};
\node[labeltext,font=\thesisfigurefont\bfseries] at (6.55,-.37) {医学多模态\\持续学习};
\node[labeltext,text=black!65,font=\sffamily\heiti\fontsize{8bp}{10bp}\selectfont] at (6.55,-1.12) {稳定性\,$\leftrightarrow$\,可塑性};
