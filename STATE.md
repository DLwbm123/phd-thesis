...
- 第五章已将静态弱监督论文内容改为明确的文献基础，并集成 ScribbleCL 协议与待实验分析、SAMCL 方法和原始实验，整体为 `drafted_pending_review`；5.3.2 的 ScribbleCL 结果仍为 `TODO-EXPERIMENT` / `blocked_by_experiments`。
