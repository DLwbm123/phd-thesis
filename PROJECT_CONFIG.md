...
- Thesis class/template: `FDSDSthesis` v1.1（用户提供；模板实现、字体和复旦标识资源均随工程保留）
...
- Full build verification: 2026-08-14 已在 FDSDSthesis v1.1 模板下完成 XeLaTeX/BibTeX 构建，生成 167 页 `main.pdf`。
